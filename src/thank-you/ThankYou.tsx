...
// this ThankYou page comes in 3 state 
// 1--> Loading phase
// 2-->Not paid phase 
// 3--> Paid phase
const ThankYou = ()=>{
    ...
    // 3--> Paid phase
    const {shippingAddress,billingAddress,configuration,amount} = data
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:py-24 lg:px-8">
            <div className="max-w-xl">
                ...
                <p className="mt-2 text-base text-zinc-500">
                    We recieved your order and we are now proccessing it..
                </p>
                <div className="mt-12 font-md text-sm">
            ...
            <div className="mt-10 border-t border-zinc-200">
                <div className="mt-10 flex flex-auto flex-col">
                    ...
                    <p className="mt-2 text-sm text-zinc-600">
                        we at WallpaerCase believe that phone case doesn't need only look good but the print quality also matters i.e we provide the 3-year print gaurantee.
                        if any problem occurs then we will replace it Free.
                    </p>
                </div>
            </div>
